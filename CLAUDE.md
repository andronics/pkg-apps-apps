# apps - AI Assistant Instructions
...
**Description**: Application Launcher - Quick application access

**Purpose**: Provide application launcher - quick application access functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/apps` - Main executable
- `.local/bin/apps.phase4.backup` - Main executable
...
1. **Test installation**: `stow apps`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D apps`
