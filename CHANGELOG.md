...
All notable changes to @apps/apps will be documented in this file.
...
- Declared external command requirements: dmenu
...
- Package naming now includes collection scope: `@apps/apps`
